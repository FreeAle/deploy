...
<div class="container-fluid animated bounceInRight" id="main">
    <div class="card">
        <div class="header"> <input type="button" onclick="done({{$data['id']}});" value="Done"
                class="btn btn-lg bg-orange waves-effect">&nbsp;&nbsp;
            <input type="button" class="btn btn-lg bg-red waves-effect" onclick="backToMain('service');"
                value="cancel">&nbsp;&nbsp;</div>
    </div>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2>
                   <b>{{$data['service_name']}} </b>Employee's.
                </h2>
...
<script type="text/javascript">
    ...
    function backToMain() {
        ...
        // window.location.href = name+'/'+ 'service';
    ...
    function done(id) {
        ...
        var fd = new FormData();
        fd.append('emp', serializedData?serializedData.toString():'')
        $.ajax({
            url: id,
            method: 'post',
            headers: {
